 ...
 */
function get_required_string( $user_data, $name, $label, $minlength, $maxlength, &$errors )
{
    ...
    {
        $errors[] = "{$label} must be {$maxlength} characters or less";
        return NULL;
    }
	if ( strlen($value) < $minlength )
	{
		$errors[] = "{$label} must be {$minlength} characters or more";
		return NULL;
	}
    return $value;
}
